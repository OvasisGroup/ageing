                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-muted-foreground mt-2 space-y-1 list-disc list-inside">
                      <li>All your bookings and client appointments will be canceled</li>
                      <li>Your provider profile and business information will be permanently deleted</li>
                      <li>You will lose access to all messages, earnings history, and client data</li>
